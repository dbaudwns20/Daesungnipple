...
//  * @returns ProductCategory[]
//  */
// export function groupByParentId(list: ProductCategory[]): ProductCategory[] {
//   const groupMap: Map<number, ProductCategory[]> = new Map();
//   const topLevelMap: Map<number, ProductCategory> = new Map();
//
//   list.forEach((it: ProductCategory) => {
//       // 카테고리 자신의 ID로 그룹화
//       if (!groupMap.has(it.id)) {
//         groupMap.set(it.id, []);
//       }
//       // 부모 카테고리 아이디 조회하기
