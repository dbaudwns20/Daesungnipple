...
import { useState, useRef, useEffect, useTransition, FormEvent, ChangeEvent } from "react";
  ...
  return (
    <div className="flex flex-col space-y-4">
      ...
      <div className="flex flex-row space-x-4">
        <div className="flex flex-col w-[50%] p-2 bg-pink-200">

        </div>
        <div className="flex flex-col w-[50%] p-2 bg-yellow-200">
